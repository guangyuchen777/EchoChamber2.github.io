...
function mouseWheel(event) {
	if (FilterNumber == 1) {
		translateX -= mouseX;
		translateY -= mouseY;
		const delta = event.delta < 0 ? 1.4 : event.delta > 0 ? 1.0/1.4 : 1.0;
		scaleFactor *= delta;
		translateX *= delta;
		translateY *= delta;
		translateX += mouseX;
    ...
    if (FilterNumber == 2) {
		translateX2 -= mouseX;
		translateY2 -= mouseY;
		const delta2 = event.delta < 0 ? 1.4 : event.delta > 0 ? 1.0/1.4 : 1.0;
		scaleFactor2 *= delta2;
		translateX2 *= delta2;
		translateY2 *= delta2;
		translateX2 += mouseX;
    ...
    if (FilterNumber == 3) {
		translateX3 -= mouseX;
		translateY3 -= mouseY;
		const delta3 = event.delta < 0 ? 1.4 : event.delta > 0 ? 1.0/1.4 : 1.0;
		scaleFactor3 *= delta3;
		translateX3 *= delta3;
		translateY3 *= delta3;
		translateX3 += mouseX;
